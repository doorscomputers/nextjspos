...
test.describe('Analytics Dashboard Page', () => {
  ...
  test('should load page within performance threshold', async ({ page }) => {
    ...
    await page.goto(`${process.env.BASE_URL || 'http://localhost:3000'}/dashboard/analytics-devextreme`)
    ...
    console.log(`Analytics Dashboard - Load time: ${loadTime}ms, First paint: ${firstPaintTime}ms`)
  })
