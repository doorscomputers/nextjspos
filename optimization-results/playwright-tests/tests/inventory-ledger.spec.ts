...
test.describe('Inventory Ledger Page', () => {
  ...
  test('should load page within performance threshold', async ({ page }) => {
    ...
    await page.goto(`${process.env.BASE_URL || 'http://localhost:3000'}/dashboard/reports/inventory-ledger`)
    ...
    console.log(`Inventory Ledger - Load time: ${loadTime}ms, First paint: ${firstPaintTime}ms`)
  })
