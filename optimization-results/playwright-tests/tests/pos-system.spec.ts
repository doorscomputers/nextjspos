...
test.describe('POS System Page', () => {
  ...
  test('should load page within performance threshold', async ({ page }) => {
    ...
    await page.goto(`${process.env.BASE_URL || 'http://localhost:3000'}/dashboard/pos`)
    ...
    console.log(`POS System - Load time: ${loadTime}ms, First paint: ${firstPaintTime}ms`)
  })
