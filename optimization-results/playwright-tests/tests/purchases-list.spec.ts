...
test.describe('Purchases List Page', () => {
  ...
  test('should load page within performance threshold', async ({ page }) => {
    ...
    await page.goto(`${process.env.BASE_URL || 'http://localhost:3000'}/dashboard/purchases`)
    ...
    console.log(`Purchases List - Load time: ${loadTime}ms, First paint: ${firstPaintTime}ms`)
  })
