    ...
    const alerts = await prisma.overtimeAlert.findMany({
      ...
      select: {
        ...
        attendance: {
          select: {
            id: { select: { id: true, name: true } },
            clockIn: { select: { id: true, name: true } },
            clockOut: { select: { id: true, name: true } },
            totalHoursWorked: { select: { id: true, name: true } },
            scheduledHours: { select: { id: true, name: true } },
            overtimeHours: { select: { id: true, name: true } },
          }
        },
        acknowledger: {
          select: {
