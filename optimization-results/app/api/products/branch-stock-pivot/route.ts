    ...
    const stockData = await prisma.variationLocationDetails.findMany({
      where: {
        product: {
          businessId,
          deletedAt: null,
          isActive: { select: { id: true, name: true } }, // Only fetch active products
        },
        productVariation: {
          deletedAt: null,
        },
      ...
      select: {
        ...
        product: {
          select: {
            ...
            unit: { select: { shortName: { select: { id: true, name: true } } } },
          },
        },
        productVariation: {
          select: {
            ...
            lastPurchaseDate: { select: { id: true, name: true } },
            lastPurchaseQuantity: { select: { id: true, name: true } },
            lastPurchaseCost: { select: { id: true, name: true } },
            unit: { select: { shortName: { select: { id: true, name: true } } } },
