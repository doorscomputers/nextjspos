...
export async function GET(
  ...
  try {
    ...
    const correction = await prisma.inventoryCorrection.findFirst({
      ...
      select: {
        business: {
          select: { id: { select: { id: { select: { id: true, name: true } }, name: { select: { id: true, name: true } } } }, name: { select: { id: true, name: true } } }
        },
        location: {
        ...
        createdByUser: {
          select: { id: { select: { id: true, name: true } }, username: { select: { id: true, name: true } }, firstName: { select: { id: true, name: true } }, lastName: { select: { id: true, name: true } } }
        },
        approvedByUser: {
          select: { id: { select: { id: true, name: true } }, username: { select: { id: true, name: true } }, firstName: { select: { id: true, name: true } }, lastName: { select: { id: true, name: true } } }
        },
        stockTransaction: { select: { id: true, name: true } }
      }
    })
...
export async function PUT(
  ...
  try {
    ...
    const existing = await prisma.inventoryCorrection.findFirst({
      ...
      select: {
        product: { select: { name: { select: { id: { select: { id: true, name: true } }, name: { select: { id: true, name: true } } } }, sku: { select: { id: true, name: true } } } },
        productVariation: { select: { name: { select: { id: true, name: true } }, sku: { select: { id: true, name: true } } } },
    ...
    const correction = await prisma.inventoryCorrection.update({
      ...
      data: updateData,
      select: {
        product: { select: { id: { select: { id: { select: { id: true, name: true } }, name: { select: { id: true, name: true } } } }, name: { select: { id: true, name: true } }, sku: { select: { id: true, name: true } } } },
        productVariation: { select: { id: { select: { id: true, name: true } }, name: { select: { id: true, name: true } }, sku: { select: { id: true, name: true } } } },
