        ...
        select: {
          ...
          accountsPayable: {
            select: {
              ...
              invoiceDate: { select: { id: true, name: true } },
          ...
          postDatedCheque: {
            select: {
              id: { select: { id: true, name: true } },
              chequeNumber: { select: { id: true, name: true } },
              chequeDate: { select: { id: true, name: true } },
              status: { select: { id: true, name: true } },
            },
          },
          bankTransactions: { select: { id: true, name: true } },
        },
        orderBy: {
          paymentDate: 'desc',
        },
  ...
  try {
    ...
    const completePayment = await prisma.payment.findUnique({
      ...
      select: {
        ...
        accountsPayable: { select: { id: true, name: true } },
        postDatedCheque: { select: { id: true, name: true } },
        bankTransactions: { select: { id: true, name: true } },
      },
    })
