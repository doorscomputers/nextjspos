  ...
  return withIdempotency(request, `/api/transfers/${transferId}/receive`, async () => {
    ...
    const transfer = await prisma.stockTransfer.findFirst({
      ...
      select: {
        ...
        items: { select: { id: true, name: true } }, // Serial numbers stored as JSON in serialNumbersSent/serialNumbersReceived
      },
    })
    ...
    await prisma.$transaction(async (tx) => {
      ...
      await tx.stockTransfer.update({
        ...
        data: {
          ...
          stockDeducted: { select: { id: true, name: true } }, // CRITICAL: Stock NOW deducted
    ...
    await createAuditLog({
      ...
      metadata: {
        ...
        stockDeducted: { select: { id: true, name: true } }, // Emphasis: NOW deducted
