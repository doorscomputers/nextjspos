  ...
  try {
    ...
    const completedTransfers = await prisma.stockTransfer.findMany({
      ...
      select: {
        ...
        submittedAt: { select: { id: true, name: true } },
        checkedAt: { select: { id: true, name: true } },
        approvedAt: { select: { id: true, name: true } },
        sentAt: { select: { id: true, name: true } },
        arrivedAt: { select: { id: true, name: true } },
        verifiedAt: { select: { id: true, name: true } },
        completedAt: { select: { id: true, name: true } },
      }
    })
