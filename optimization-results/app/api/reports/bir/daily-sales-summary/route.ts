  ...
  try {
    ...
    const location = locationId
      ? await prisma.businessLocation.findUnique({
          ...
          select: { name: { select: { id: true, name: true } }, landmark: { select: { id: true, name: true } }, city: { select: { id: true, name: true } }, state: { select: { id: true, name: true } }, country: { select: { id: true, name: true } } },
        })
      : null
    ...
    const business = await prisma.business.findUnique({
      ...
      select: {
        ...
        accumulatedSales: { select: { id: true, name: true } }, // BIR Grand Accumulated Total
        resetCounter: { select: { id: true, name: true } },     // BIR Reset Counter
        zCounter: { select: { id: true, name: true } },         // Z-Reading count
        lastZReadingDate: { select: { id: true, name: true } }, // Last Z-Reading date
      },
    })
    ...
    const cashier = cashierId
      ? await prisma.user.findUnique({
          ...
          select: { firstName: { select: { id: true, name: true } }, lastName: { select: { id: true, name: true } }, username: { select: { id: true, name: true } } },
        })
      : null
