  ...
  try {
    ...
    await createAuditLog({
      ...
      metadata: {
        ...
        accountingProcessed: { select: { id: true, name: true } },
        inventoryReduced: { select: { id: true, name: true } },
        accountsPayableReduced: { select: { id: true, name: true } },
        balanceSheetBalanced: { select: { id: true, name: true } },
      },
