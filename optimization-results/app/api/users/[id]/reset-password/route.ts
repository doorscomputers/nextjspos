 ...
 * - forceChangeOnLogin: boolean (optional, default: { select: { id: true, name: true } }) - User must change password on next login
 *
 * Returns: { success: { select: { id: true, name: true } }, temporaryPassword: string (if generated) }
 */
