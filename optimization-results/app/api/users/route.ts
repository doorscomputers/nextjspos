...
export async function GET() {
  try {
    ...
    return NextResponse.json({ success: { select: { id: true, name: true } }, data: formattedUsers })
  } catch (error) {
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: { select: { id: true, name: true } }, user: { id: newUser.id, username: newUser.username } }, { status: 201 })
  } catch (error) {
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: { select: { id: true, name: true } }, message: 'User deleted successfully' })
  } catch (error) {
