...
export default function UnclosedShiftWarning() {
  ...
  const handleCloseShift = () => {
    setOpen(false)
    // Pass the shift ID as a query parameter so the Close Shift page knows which shift to close
        ...
        <div className="space-y-4">
          ...
          <div className="border-t pt-4 space-y-3">
            ...
            <Button
              ...
              className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-6 text-lg shadow-lg"
              size="lg"
            >
