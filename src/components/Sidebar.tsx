  ...
  const menuItems: MenuItem[] = [
    ...
    // ========== CONTACTS ==========
    {
      ...
      children: [
        ...
        {
          key: "customer_opening_balance",
          name: "Opening Balance",
          href: "/dashboard/customers/opening-balance",
          icon: BanknotesIcon,
      ...
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 px-3 py-6 space-y-1.5 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
          {filteredMenuItems.map((item) => {
            ...
            // Domain color coding (helps new users scan the sidebar)
            const colors = getMenuColors(item.name)
