        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            ...
            <ol className="space-y-2 text-sm text-blue-800 dark:text-blue-200 list-decimal list-inside">
              <li><strong>Step 1:</strong> Search for a product by SKU or name</li>
              <li><strong>Step 2:</strong> Review product details (cost price for reference)</li>
              <li><strong>Step 3:</strong> Select the location(s) where you want to update the price</li>
              <li><strong>Step 4:</strong> Enter the new selling price and click "Update Price"</li>
            </ol>
