          ...
          <div className="mb-6">
            <label className="flex items-start">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 italic">Enable stock management at product level. Uncheck ONLY for services/charges with no physical inventory.</div>
              </div>
            </label>
          </div>
