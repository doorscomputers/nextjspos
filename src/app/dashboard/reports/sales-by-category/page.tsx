...
import { RefreshCw, Users, DollarSign, ShoppingCart, TrendingUp, FileSpreadsheet, FileText, Printer, ChevronDown, ChevronUp } from 'lucide-react'
import DataGrid, {
  Column,
  FilterRow,
  HeaderFilter,
...
export default function SalesByCategoryReport() {
  ...
  const fetchReport = async () => {
    ...
    try {
      ...
      if (customerCategory && customerCategory !== 'all') params.append('customerCategory', customerCategory)
      if (locationId && locationId !== 'all') params.append('locationId', locationId)

      const response = await fetch(`/api/reports/sales-by-category?${params.toString()}`)
    ...
    exportDataGrid({
      ...
      workbook.xlsx.writeBuffer().then((buffer) => {
        saveAs(
          ...
          `Sales_by_Category_${startDate}_to_${endDate}.xlsx`
        )
      })
    })
  }
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(16)
    doc.text('Sales Report by Customer Category', 14, 15)
    doc.setFontSize(10)
    ...
    ;(doc as any).autoTable({
      startY: 28,
      head: [['Category', 'Sales Count', 'Items Sold', 'Total Revenue']],
      body: summaryData,
      foot: grandTotals ? [[
        'GRAND TOTAL',
    ...
    doc.save(`Sales_by_Category_${startDate}_to_${endDate}.pdf`)
  }
  ...
  if (!can(PERMISSIONS.SALES_REPORT_VIEW)) {
    return (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 p-4 sm:p-6 lg:p-8 print:p-0 print:bg-white">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-slate-600 text-sm dark:text-gray-400 print:hidden">
              Analyze sales grouped by customer category type
            </p>
          </div>
        ...
        <Card className="shadow-md dark:bg-gray-800 dark:border-gray-700">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-slate-500 dark:text-gray-400">Categories</div>
        ...
        <CardContent className="p-0">
          {viewMode === 'summary' ? (
            ...
            >
              ...
              <Column dataField="category" caption="Customer Category" minWidth={180} />
            ...
            >
              ...
              <Column dataField="customerCategory" caption="Customer Category" groupIndex={0} />
              ...
              <Column dataField="salesPersonnelName" caption="Sales Personnel" width={150} />
      ...
      <div className="hidden print:block print:text-center print:mb-4">
        <h1 className="text-xl font-bold">Sales by Customer Category Report</h1>
