...
SELECT
  ...
  MAX(CASE WHEN vld.location_id = 1 THEN vld.qty_available ELSE 0 END) AS loc_1_qty,
  MAX(CASE WHEN vld.location_id = 2 THEN vld.qty_available ELSE 0 END) AS loc_2_qty,
  MAX(CASE WHEN vld.location_id = 3 THEN vld.qty_available ELSE 0 END) AS loc_3_qty,
  MAX(CASE WHEN vld.location_id = 4 THEN vld.qty_available ELSE 0 END) AS loc_4_qty,
  MAX(CASE WHEN vld.location_id = 5 THEN vld.qty_available ELSE 0 END) AS loc_5_qty,
  MAX(CASE WHEN vld.location_id = 6 THEN vld.qty_available ELSE 0 END) AS loc_6_qty,
  MAX(CASE WHEN vld.location_id = 7 THEN vld.qty_available ELSE 0 END) AS loc_7_qty,
  MAX(CASE WHEN vld.location_id = 8 THEN vld.qty_available ELSE 0 END) AS loc_8_qty,
  MAX(CASE WHEN vld.location_id = 9 THEN vld.qty_available ELSE 0 END) AS loc_9_qty,
  MAX(CASE WHEN vld.location_id = 10 THEN vld.qty_available ELSE 0 END) AS loc_10_qty,
  MAX(CASE WHEN vld.location_id = 11 THEN vld.qty_available ELSE 0 END) AS loc_11_qty,
  MAX(CASE WHEN vld.location_id = 12 THEN vld.qty_available ELSE 0 END) AS loc_12_qty,
  MAX(CASE WHEN vld.location_id = 13 THEN vld.qty_available ELSE 0 END) AS loc_13_qty,
  MAX(CASE WHEN vld.location_id = 14 THEN vld.qty_available ELSE 0 END) AS loc_14_qty,
  MAX(CASE WHEN vld.location_id = 15 THEN vld.qty_available ELSE 0 END) AS loc_15_qty,
  MAX(CASE WHEN vld.location_id = 16 THEN vld.qty_available ELSE 0 END) AS loc_16_qty,
  MAX(CASE WHEN vld.location_id = 17 THEN vld.qty_available ELSE 0 END) AS loc_17_qty,
  MAX(CASE WHEN vld.location_id = 18 THEN vld.qty_available ELSE 0 END) AS loc_18_qty,
  MAX(CASE WHEN vld.location_id = 19 THEN vld.qty_available ELSE 0 END) AS loc_19_qty,
  MAX(CASE WHEN vld.location_id = 20 THEN vld.qty_available ELSE 0 END) AS loc_20_qty,
